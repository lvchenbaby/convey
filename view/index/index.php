...
<table width="780" border="0" cellspacing="0" cellpadding="0">
 ...
 ?>
  ...
  <tr>
    <td width="52" align="center">&nbsp;</td>
    <td height="35" data-id="<?php echo $v->id; ?>" class="items-wrapper" data-rule="<?php echo $v->rule; ?>" data-type="<?php echo $v->type ?>" data-required="<?php echo $v->required ?>" data-otherfield="<?php echo $v->otherfields ?>">
    <?php foreach($v->items as $idx=>$item): ?>
